...
$.fn.hijriDate = function (options = {}) {
  ...
  function hijriToString() {
    var hijriDates = defaultOptions.hijriLang == "ar" ? ConvertToHjri(this.day) : this.day;
    var hijriYear = defaultOptions.hijriLang == "ar" ? ConvertToHjri(this.year) : this.year;
    return `${hijriDates} ${hijriMonths[defaultOptions.hijriLang][this.month - 1]} ${hijriYear}`;
  }
